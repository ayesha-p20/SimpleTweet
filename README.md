...
<img src='https://github.com/ayesha-p20/SimpleTweet/blob/master/walkthrough_wk3.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I did not encounter any challenges while building this app. However, due to some reason, I couldn't spend as much time as I wanted to on this project. Neverhteless, I intend to make up for this in the next assignment.
...
- [x] The tweet button is disabled when the character count is not in range [0,280]

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/ayesha-p20/SimpleTweet/blob/master/walkthrough_wk4.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I didn't really face any challenges while creating this app.
